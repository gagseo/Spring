...
//	= new MemberDao();
	...
	public String idCheck(String id) /* throws SQLException */ {
		...
		return  mDao.idCheck(/* conn, */ id);
	}

//	@Transactional(rollbackFor = Exception.class) 이것을 쓰면 쓰로우 이쎕션이 뜨면 롤백을 해준다.
	public int insertMember(Map<String, Object> commandMap) throws SQLException /* throws SQLException */ {

		int	res = mDao.insertMember(/* conn, */commandMap);
...
//		throw new SQLException();
	...
	public Member login(Map<String, Object> m) /* throws SQLException */ {

		Member res = null;
		res = mDao.login(/* conn, */ m);
